...
class PolyDemo extends JFrame {
	...
	public class PolyDemoPanel extends JPanel {
		...
		public Shape getRandShape() {
			...
			case 0:
				retVal = new Square(x, y, getRandInt(), Color.DARK_GRAY);
				break;
			case 1:
			...
			case 2:
				...
				break;
			case 3:
				retVal = new Triangle(x, y, getRandInt(), Color.MAGENTA);
				break;
			case 4:
				retVal = new Rectangle(x, y, getRandInt(), getRandInt()/getRandInt(), Color.GREEN);
				break;

			case 5: 
				retVal = new Cylinder (x, y, getRandInt(), getRandInt()/getRandInt(), Color.PINK);
				break;
